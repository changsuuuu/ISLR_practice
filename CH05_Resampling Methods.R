...
# cross-validation that contains an element of randomness, so that the results obtained
# can be reproduced precisely at a later time.
...
cv.error.10 # computation time is shorter than that of LOOCV.
